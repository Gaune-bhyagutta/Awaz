...
//        timerTV.setText("00:00:00");
    ...
    public static void updateDecibel(float decibel) {
        //The CALCULATED DECIBEL VALUE IN AudioPlayClassMain/AudioRecordClass is SENT to show in TEXTVIEW
        decibelTV.setText(String.valueOf(decibel));
    }

    public static void updateFrequncy(float frequency) {
        //The CALCULATED FREQUNCY VALUE IN AudioPlayClassMain/AudioRecordClass is SENT to show in TEXTVIEW
